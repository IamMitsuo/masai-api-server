...
RULES = [
    {
        'desc': 'Files may contain hardcoded sensitive informations like usernames, passwords, keys etc. [M2-Insecure Data Storage]',
    ...
    {
        'desc': 'IP Address disclosure. [M3-Insecure Communication]',
    ...
    {
        'desc': 'Hidden elements in view can be used to hide data from user. But this data can be leaked. [M2-Insecure Data Storage]',
		'owasp': 'M2-Insecure Data Storage',
        'type': 'regex',
    ...
    {
        'desc': 'The App uses ECB mode in Cryptographic encryption algorithm. ECB mode is known to be weak as it results in the same ciphertext for identical blocks of plaintext. [M5-Insufficient Cryptography]',
    ...
    {
        'desc': 'This App uses RSA Crypto without OAEP padding. The purpose of the padding scheme is to prevent a number of attacks on RSA that only work when the encryption is performed without padding. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'regex',
    ...
    {
        'desc': 'Insecure Implementation of SSL. Trusting all the certificates or accepting self signed certificates is a critical Security Hole. This application is vulnerable to MITM attacks. [M3-Insecure Communication]',
        'owasp': 'M3-Insecure Communication',
		'type': 'regex',
    ...
    {
        'desc': 'WebView load files from external storage. Files in external storage can be modified by any application. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
		'type': 'regex',
    ...
    {
        'desc': 'The file is World Readable. Any App can read from the file. [M1-Improper Platform Usage]',
    ...
    {
        'desc': 'The file is World Writable. Any App can write to the file. [M1-Improper Platform Usage]',
        'owasp': 'M1-Improper Platform Usage',
		'type': 'regex',
    ...
    {
        'desc': 'The file is World Readable and Writable. Any App can read/write to the file. [M1-Improper Platform Usage]',
        'owasp': 'M1-Improper Platform Usage',
		'type': 'regex',
    ...
    {
        'desc': 'Weak Hash algorithm used. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'regex',
    ...
    {
        'desc': 'MD5 is a weak hash known to have hash collisions. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'regex',
    ...
    {
        'desc': 'SHA-1 is a weak hash known to have hash collisions. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'regex',
    ...
    {
        'desc': 'App can write to App Directory. Sensitive Information should be encrypted. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
		'type': 'regex',
    ...
    {
        'desc': 'The App uses an insecure Random Number Generator. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'regex',
    ...
    {
        'desc': 'The App logs information. Sensitive information should never be logged. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
		'type': 'regex',
    ...
    {
        'desc': 'This App uses Java Hash Code. It\'s a weak hash function and should never be used in Secure Crypto Implementation. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
		'type': 'string',
        'string1': '.hashCode()',
        'level': 'high',
    ...
    {
        'desc': 'App can read/write to External Storage. Any App can read data written to External Storage. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
    ...
    {
        'desc': 'App creates temp file. Sensitive information should never be written into a temp file. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
        'perm': 'android.permission.WRITE_EXTERNAL_STORAGE',
        'type': 'string',
    ...
    {
        'desc': 'Insecure WebView Implementation. Execution of user controlled code in WebView is a critical Security Hole. [M1-Improper Platform Usage]',
        'owasp': 'M1-Improper Platform Usage',
        'type': 'string',
    ...
    {
        'desc': 'The App may use weak IVs like "0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00" or "0x01,0x02,0x03,0x04,0x05,0x06,0x07". Not using a random IV makes the resulting ciphertext much more predictable and susceptible to a dictionary attack. [M5-Insufficient Cryptography]',
        'owasp': 'M5-Insufficient Cryptography',
        'type': 'string',
    ...
    {
        'desc': 'Remote WebView debugging is enabled. [M9-Reverse Engineering]',
    ...
    {
        'desc': 'Insecure WebView Implementation. WebView ignores SSL Certificate errors and accept any SSL Certificate. This application is vulnerable to MITM attacks. [M3-Insecure Communication]',
        'owasp': 'M3-Insecure Communication',
        'type': 'string',
    ...
    {
        'desc': 'App uses SQLite Database and execute raw SQL query. Untrusted user input in raw SQL queries can cause SQL Injection. Also sensitive information should be encrypted and written to the database. [M2-Insecure Data Storage]',
        'owasp': 'M2-Insecure Data Storage',
        'type': 'string',
    ...
    {
        'desc': 'This App detects frida server. [M9-Reverse Engineering]',
        'owasp': 'M9-Reverse Engineering',
        'type': 'string',
        'string1': 'fridaserver',
        'string_or1': '27047',
    ...
    {
        'desc': 'DexGuard code to detect wheather the App is signed with a debug key or not is identified.',
        'owasp': '',
        'type': 'string',
        'string1': 'import dexguard.util',
